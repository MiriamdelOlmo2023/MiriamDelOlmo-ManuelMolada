...
const view = {
    ...
    confirmar: function() {
     ...
     cancelar: function() {
        var cantApostada = parseInt(document.getElementById("cantApostado").innerHTML);

        model.actualizarSaldo(controller.cogerSaldo() + cantApostada);
    ...
    actualizarSaldo: function(saldo) {
        document.getElementById("fichas").innerHTML = saldo;
    },
...
const controller = {
    ...
    cogerSaldo: function() {
        var saldoNumero = parseInt(document.getElementById("fichas").innerHTML);
        return saldoNumero;
    },
    ...
    generarCarrera: function() {
        ...
        if(apuestaCarrera){
            ...
            if (nombresClasificados.includes(apuestaCarrera.nombre)) {
				premio = parseInt(apuestaCarrera.cant);
            ...
            llamadaApuestasGalgos(apuestaCarrera.cant, premio, carreraslst[numCarreraSeleccionada].circuito.nombre, apuestaCarrera.nombre);
        }
        view.modificarBotonEmpezarCarrera(true);
    },
...
'use strict'
function llamada(fichas) {
    $.ajax({
        type: "POST",
        url: "/llamadaFichasGalgos",
...
'use strict'
function llamadaApuestasGalgos(apostado, ganado, circuito, yoshi){
    var fechaActual = new Date();
